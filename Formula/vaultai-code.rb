class VaultaiCode < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/VaultAI-EU/vaultai_release/releases/download/vaultai-code-v0.9.9/vaultai-code-darwin-arm64.zip"
      sha256 "c7f085b1f617185d92af6c9f6620e21c10b45454cc3b71a6b58e243d869524f2"
    else
      url "https://github.com/VaultAI-EU/vaultai_release/releases/download/vaultai-code-v0.9.9/vaultai-code-darwin-x64.zip"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/VaultAI-EU/vaultai_release/releases/download/vaultai-code-v0.9.9/vaultai-code-linux-arm64.tar.gz"
      sha256 "3447d4020b6aab79b44c8d5d8874cb687730ccf718f2943d237701ceeee92ddc"
    else
      url "https://github.com/VaultAI-EU/vaultai_release/releases/download/vaultai-code-v0.9.9/vaultai-code-linux-x64.tar.gz"
